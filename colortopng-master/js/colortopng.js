...
solid_save.addEventListener("click", function() {
    solid_save.href = solid_canvas.toDataURL();
    solid_save.download = "colortopng.png";
}, false);
/* ===== SOLID ===== */
...
gradient_save.addEventListener("click", function() {
    gradient_save.href = gradient_canvas.toDataURL();
    gradient_save.download = "colortopng.png";
}, false);
/* ===== GRADIENT ===== */
