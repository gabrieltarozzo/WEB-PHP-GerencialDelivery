 ...
 <h2> Terça-Feira </h2>
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time1" name="appt-time5" value="<?php echo $ini3; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time2" name="appt-time6" value="<?php echo $fim3; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p></p>
        <div style="width:100%;">
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time3" name="appt-time7" value="<?php echo $ini4; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time4" name="appt-time8" value="<?php echo $fim4; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p>
        <div style="width:100%;">
 ...
 <h2> Quarta-Feira </h2>
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time1" name="appt-time9" value="<?php echo $ini5; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time2" name="appt-time10" value="<?php echo $fim5; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p></p>
        <div style="width:100%;">
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time3" name="appt-time11" value="<?php echo $ini6; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time4" name="appt-time12" value="<?php echo $fim6; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p>
        <div style="width:100%;">
 ...
 <h2> Quinta-Feira </h2>
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time1" name="appt-time13" value="<?php echo $ini7; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time2" name="appt-time14" value="<?php echo $fim7; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p></p>
        <div style="width:100%;">
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time3" name="appt-time15" value="<?php echo $ini8; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time4" name="appt-time16" value="<?php echo $fim8; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p>
        <div style="width:100%;">
 ...
 <h2> Sexta-Feira </h2>
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time1" name="appt-time17" value="<?php echo $ini9; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time2" name="appt-time18" value="<?php echo $fim9; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p></p>
        <div style="width:100%;">
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time3" name="appt-time19" value="<?php echo $ini10; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time4" name="appt-time20" value="<?php echo $fim10; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p>
        <div style="width:100%;">
 ...
 <h2> Sábado </h2>
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time1" name="appt-time21" value="<?php echo $ini11; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time2" name="appt-time22" value="<?php echo $fim11; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p></p>
        <div style="width:100%;">
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time3" name="appt-time23" value="<?php echo $ini12; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time4" name="appt-time24" value="<?php echo $fim12; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p>
        <div style="width:100%;">
 ...
 <h2> Domingo </h2>
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time1" name="appt-time25" value="<?php echo $ini13; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time2" name="appt-time26" value="<?php echo $fim13; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p></p>
        <div style="width:100%;">
  ...
  <br>
    <div class="control">
        ...
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time3" name="appt-time27" value="<?php echo $ini14; ?>"
               required />
       <span  class="hours">Abertura.</span>
       <p>
        <div style="width:100%;">
    ...
    <br>
        ...
        <div class="control">
        <label for="appt-time">Horário:</label>
        <input type="time" id="appt-time4" name="appt-time28" value="<?php echo $fim14; ?>"
                required />
       <span class="hours">Encerramento.</span>
       <p> </p>
        <div style="width:100%;">
