        ...
        <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="dashboardformapagamento.php">Relatório Entrega/Retirada</a></li>
                </ul>
            </li>
        </ul>
...
<link href="js/calendar/bootstrap-datepicker.css" rel="stylesheet"/>
  ...
  <body>
    ...
    $resultCountCXQ = "SELECT * FROM EMPRESAS ";
    $resCountCXQ = mysqli_query($conn, $resultCountCXQ);
    $dataCXQ = mysqli_fetch_assoc($resCountCXQ);
    $datatotalCXQ = mysqli_num_rows($resCountCXQ);
...
Identifique a empresa:
 ...
 <select  onchange="return clica(this);" class="form-control " style="width:200px;" id="test1" name="test1">
   <?php while($rows_empresas = mysqli_fetch_assoc($resCountCXQ)){ ?>
          <option name="meuID" value="<?php echo $rows_empresas["ID_EMPRESA"]; ?>">  <?php echo $rows_empresas["NOME"]; ?> </option>
         <?php } ?>
</select>
...
<br>
  ...
  <?php
        ...
        $MEUVALORE = $rows_categoriasw['vlr_valor'] + $newCd + $newAd + $newMax2; ?>
              ...
              $rowtotal = $rows_categoriase['qtde'] + $datatotal;
               ...
               $porcettotal = $porcettotal + $porcet ;
                ...
                <td style="white-space:nowrap;">R$ <?php echo number_format($newvalor,2,",","");  ?></td>
                 <td><?php $qtdsoma2=  $rows_categorias['quantidadesoma']; echo number_format($qtdsoma2,0 ,",",""); ?></td>
