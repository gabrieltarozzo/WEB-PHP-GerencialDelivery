...
$params = explode(',', $idAD);
    ...
    $sql="DELETE FROM complementos_produto where id_user='$idUser' and id_produto = '$idProdutoP' ";
...
foreach($params as $result) {
    $sql="insert into complementos_produto(id_complemento,id_produto,id_user)
