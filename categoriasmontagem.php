...
A:
	...
	$result_categorias = "SELECT * FROM categoria_produtos where montagem = '1' and empresa = '$filterEmp' ORDER BY (nome) ASC";
 ...
 <div id="main"  >
 	...
 	<div >
		<div style="margin-bottom: 20px;margin-top:20px;margin-left:12px;" class="col-sm-3 col-ls-3 col-xs-3 col-md-3">
			<h2>Definições de Montagem</h2>

	</div>
      <div style="margin-top:40px;margin-right:30px;" align="right">
        <a href="cadastrar_categoria.php" class="btn btn-primary">Cardápio</a>
    </div>
	</div>
<!--			<div style="margin-top:40px;margin-right:30px;" align="right">
...
<table  id="example3" align="center" style="width:100%;" class="table table-striped table-hover table " cellspacing="0" cellpadding="0">
				...
				<tbody>
								...
								while($rows_categorias = mysqli_fetch_assoc($resultado_categorias)){ ?>
								   ...
								   <?php $sit_id = $rows_categorias['situacao_id']; ?>
                                    <tr <?php if($sit_id == '2'){ ?> class="desativado" <?php } ?>>
										<td><h4><?php echo $rows_categorias['codigo']; ?></h4></td>
										<td > <h4><?php echo $rows_categorias['nome']; ?></h4></td>
										  <?php
                                        $id_doidi = $rows_categorias['situacao_id'];
                                        ...
                                        $n_sit = $roww['nome'];
                                         ...
                                         <!-- <a href="ativar_desativarAD/ativaAD.php"> <button style="width:50px;" id="cancelado<?php echo $rows_categorias['id']; ?>" type="submit" class="btn btn-success">+-</button> </a> --> 
                                              ...
                                              <td> <h4><?php if ($rows_categorias['adicional'] == 1) { echo 'Ativado';?>   <?php } else{  echo 'Desativado'; } ?> <?php $idOLHAE = $rows_categorias['semObs']; $idOLHA = $rows_categorias['adicional']; $idADAQUI = $rows_categorias['id']; ?> <a href="ativar_desativarAD/ativaAD.php?id=<?php echo $idADAQUI; ?>&got=<?php echo $idOLHA; ?>"><button>⇅</button> </a></h4> </td>
                                           <td> <h4><?php if ($rows_categorias['semObs'] == 1) { echo 'Ativado';} else{  echo 'Desativado'; } ?> <a href="ativar_desativarAD/OBSAD.php?id=<?php echo $idADAQUI; ?>&gote=<?php echo $idOLHAE; ?>"><button>⇅</button> </a></h4> </td>
                                         <td style="width:340px;"> <?php echo "<img class='imgt' src='imagens_categoria/".$rows_categorias['imagens']."' >" ?> </td>
										<!--<td><?php // echo $rows_categorias['created']; ?></td> pensar em adicionar imagem -->
										<td style="width:120px;" >
											<button style="margin-top:4%;width:80px;" type="button" class="btn btn-xs btn-primary teste1" data-toggle="modal" data-target="#myModal<?php echo $rows_categorias['id']; ?>"><h6 style="font-size:15px;">Visualizar<h6></button>
											...
											data-whatever="<?php echo $rows_categorias['id']; ?>" 
											data-whateverimagens="<?php echo $rows_categorias['imagens']; ?>"
											data-whatevernome="<?php echo $rows_categorias['nome']; ?>"
											data-whateveradicional="<?php echo $rows_categorias['adicional']; ?>"
											data-whatevercodigo="<?php echo $rows_categorias['codigo']; ?>"
											data-whateversituacao_id="<?php echo $rows_categorias['situacao_id']; ?>"
											data-whateversemObs="<?php echo $rows_categorias['semObs']; ?>">
											<h6 style="font-size:15px;">Definições</h6></button>
										    <button style="margin-top:4%;width:80px;" type="button" class="btn btn-xs btn-danger teste1" data-toggle="modal" data-target="#delete-modal" data-whatever="<?php echo $rows_categorias['id']; ?>"><h6 style="font-size:15px;">Excluir</h6></button>
										</td>
									</tr>

								<!-- Inicio Modal -->
								<div class="modal fade" id="myModal<?php echo $rows_categorias['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
									<div class="modal-dialog modal-ke" role="document">
										<div class="modal-content">
											<div class="modal-header headermodal">
												<link href="css/visualizar/categoria.css" rel="stylesheet">
											...
											<div class="modal-body back" align="center">
												<div class="card" style="margin-top:0;margin-bottom:0;margin:0;">
												 <div class="info-card-home" style="margin-top:0;margin-bottom:0;margin:0;" >
											<h2 style="margin-top:0;margin-bottom:0;margin:0;color: #8B0000;font-size: 24px;white-space: normal;padding:15px;"><p><?php echo $rows_categorias['nome']; ?></h2>
												 <?php echo "<img class='imgttt' src='imagens_categoria/".$rows_categorias['imagens']."' >" ?> 
		...
		<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
			<div class="modal-dialog" role="document">
				<div class="modal-content">
                    ...
                    <div class="form-group ">
              <label for="situacao_id" class="control-label"> Tipo de montagem: </label>

                <select  class="form-control " required>

                        <option value="1">Marmitex</option>
                        <option value="2">Açai</option>
              ...
              <label for="situacao_id" class="control-label">Quantidade de opções de carne selecionaveis: </label>
           ...
           <div class="form-group col-md 12">
              <label for="situacao_id" class="control-label">Quantide de opções de salada selecionaveis: </label>
