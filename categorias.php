...
A:
  ...
  $result_categorias = "SELECT * FROM categoria_produtos where empresa = '$filterEmp' ORDER BY (nome) ASC";
                      ...
                      <?php
                                        ...
                                        $n_sit = $roww['nome'];
                                         ...
                                         <!-- <a href="ativar_desativarAD/ativaAD.php"> <button style="width:50px;" id="cancelado<?php echo $rows_categorias['id']; ?>" type="submit" class="btn btn-success">+-</button> </a> --> 
                                                       ...
                                                       <td> <h4><?php if ($rows_categorias['adicional'] == 1) { echo 'Ativado';?>   <?php } else{  echo 'Desativado'; } ?> <?php $idOLHAE = $rows_categorias['semObs']; $idOLHA = $rows_categorias['adicional']; $idADAQUI = $rows_categorias['id']; ?> <a href="ativar_desativarAD/ativaAD.php?id=<?php echo $idADAQUI; ?>&got=<?php echo $idOLHA; ?>"><button style="background:transparent;border:none;margin-left:4%;"><i style="font-size:30px;" <?php if ($rows_categorias['adicional'] == 0) { ?> class="fas fa-toggle-off" <?php } ?> <?php if ($rows_categorias['adicional'] == 1) { ?> class="fas fa-toggle-on" <?php } ?>></i>  </button> </a></h4> </td>
                                           <td> <h4><?php if ($rows_categorias['semObs'] == 1) { echo 'Ativado';} else{  echo 'Desativado'; } ?> <a href="ativar_desativarAD/OBSAD.php?id=<?php echo $idADAQUI; ?>&gote=<?php echo $idOLHAE; ?>"><button style="background:transparent;border:none;margin-left:4%;"><i style="font-size:30px;" <?php if($rows_categorias['semObs'] == 0) { ?> class="fas fa-toggle-off" <?php } ?> <?php if($rows_categorias['semObs'] == 1) { ?> class="fas fa-toggle-on" <?php } ?>></i></button> </a></h4> </td>
